# ============================================================
# Praat AudioTools - Intensity_Time_Delay.praat
# Author: Shai Cohen
...
form Intensity Time Delay
    comment This script shifts the intensity envelope later in time
