...
form Spectral Comb Filter (Optimized)
...
writeInfoLine: "=== SPECTRAL COMB FILTER OPTIMIZATION ==="
...
appendInfoLine: "  Comb frequency divisor: ", comb_frequency_divisor
appendInfoLine: "  Comb center: ", comb_center
appendInfoLine: "  Comb depth: ", comb_depth
...
for i to num_chunks
    ...
    # Apply spectral comb filter (using explicit string concatenation)
    formula$ = "self[1, col] * (" + string$(comb_center) + " + " + string$(comb_depth) + " * sin(col / " + string$(comb_frequency_divisor) + "))"
    Formula: formula$
...
# STEP 7: Finalize
selectObject: resultID
outName$ = originalName$ + "_spectral_comb"
Rename: outName$
