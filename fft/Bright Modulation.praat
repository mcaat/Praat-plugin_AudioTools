...
form Bright Modulation (Optimized)
...
writeInfoLine: "=== BRIGHT MODULATION OPTIMIZATION ==="
...
if cutoff_frequency > nyquist
    ...
    appendInfoLine: "→ Cutoff adjusted to Nyquist: ", cutoff_frequency, " Hz"
endif
...
appendInfoLine: "  Modulation cutoff: ", cutoff_frequency, " Hz"
...
for i to num_chunks
    ...
    # Apply bright modulation formula
...
# STEP 7: Finalize
selectObject: resultID
outName$ = originalName$ + "_bright_modulated"
Rename: outName$
