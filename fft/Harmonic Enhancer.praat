...
form Harmonic Enhancer (Optimized)
    ...
    boolean play_after_processing 0
...
writeInfoLine: "=== HARMONIC ENHANCER OPTIMIZATION ==="
...
appendInfoLine: "  2nd harmonic weight: ", second_harmonic_weight
appendInfoLine: "  3rd harmonic weight: ", third_harmonic_weight
...
for i to num_chunks
    ...
    # Add harmonic overtones (using explicit string concatenation)
    formula$ = "self[1, col] + " + string$(second_harmonic_weight) + " * self[1, col * 2] + " + string$(third_harmonic_weight) + " * self[1, col * 3]"
    Formula: formula$
...
# STEP 7: Finalize
selectObject: resultID
outName$ = originalName$ + "_harmonic_enhanced"
Rename: outName$
