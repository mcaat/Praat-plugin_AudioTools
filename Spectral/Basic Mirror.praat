...
# ============================================================
form Spectral Mirroring (Optimized)
    ...
    comment (Only used if downsampling is enabled)
    positive chunk_duration 30
    comment (Process in chunks of N seconds)
    positive overlap_duration 2
    comment (Overlap between chunks in seconds - prevents artifacts)
    boolean force_mono 1
    comment (Mono is 2-4x faster than stereo)
...
writeInfoLine: "=== SPECTRAL MIRROR OPTIMIZATION ==="
...
appendInfoLine: "Cutoff frequency: ", cutoff, " Hz"
